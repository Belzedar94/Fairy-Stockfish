...
struct Variant {
  ...
  bool pointsCountCaptures = false;
  bool pointsCountPresent = false;
  bool pointsIncludeHand = false;
  bool pointsAdjudicateDraw = false;
  bool pointsConfigured = false;
  int pointsWin = 0;
  int pointsCheckValue = 0;
  Value pointsTieValue = VALUE_DRAW;
  int pointsOffset[COLOR_NB] = {};
  int pointsCaptureValue[PIECE_TYPE_NB] = {};
  int pointsPresentValue[PIECE_TYPE_NB] = {};
  bool pointsCaptureValueSet = false;
  bool pointsPresentValueSet = false;
  int connectN = 0;
