...
void UCI::loop(int argc, char* argv[]) {
  ...
  do {
      ...
      {
          CurrentProtocol = token == "xboard" ? XBOARD : UCI_GENERAL;
          Options["UCI_Variant"].set_default("spell-chess");
      ...
      // load/check (variant configs) removed for spell-only build
      // Allow bare FEN/startpos lines as a convenience
